...
very high res or high res imagery from geoimage (https://www.geoimage.com.au/satellites/very-high-resolution-satellites) this option requires funds


NASA's GHRSST might have high enough radiometer imagery to pick out heat signitures for blob detection (https://search.earthdata.nasa.gov/search?q=high%20resolution&ok=high%20resolution)
'''
